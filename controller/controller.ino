...
public:
  ...
  void onSent(bool success) {
    if (success) {
        ...
        Serial.printf("dir: %d, left: %d, right: %d, drive: %d \n", controlData.dir, controlData.left, controlData.right, controlData.driveSpeed); // troubleshooting
  #endif
      commsLossCount = 0;
    }
    else {
